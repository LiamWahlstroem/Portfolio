...
const CollectionCard = (props: Props): ReactElement => {
	return (
		<div
			className='min-w-1/4 w-full md:basis-1/4 p-4 border border-gray-300 rounded-lg bg-white shadow-md hover:shadow-lg transition-shadow duration-300 mx-auto md:mx-0 hover:cursor-pointer'
